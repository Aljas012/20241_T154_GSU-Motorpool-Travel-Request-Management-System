            ...
            <Col>
              ...
              <div>
                <Card style={{ backgroundColor: "#F1F1F1" }}>
                  ...
                  >
                   <Button onClick={toggleModal} variant="primary"> <i className="fa-regular fa-pen-to-square"></i> UPDATE INFORMATION</Button>
                  </div>
                </Card>
              </div>
              ...
              <Modal show={modal} onHide={toggleModal} centered>
                  <Modal.Header>
                  <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}> <Modal.Title >UPDATE INFORMATION</Modal.Title> </div>
                           </Modal.Header>
                               <Modal.Body>
                    <Form onSubmit={handleUpdate} >
                            ...
                            >
                             <InputGroup>
                              <InputGroup.Text id="basic-addon1"><i className="fa-regular fa-envelope"></i></InputGroup.Text>
                              <Form.Control
                                type="text"
                                placeholder= {email}
                                aria-label="Email"
